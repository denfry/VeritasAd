    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          <div style={{ fontSize: "60px", fontWeight: 800, lineHeight: 1.05 }}>Analyze Content</div>
          <div style={{ fontSize: "24px", opacity: 0.9 }}>Detect ads in video and social posts</div>
        </div>
